      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="card text-center py-12">
            <Users className="w-16 h-16 text-brand-600 dark:text-brand-400 mx-auto mb-4" />
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 to-emerald-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup" className="bg-white text-brand-600 dark:text-brand-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 font-semibold py-3 px-8 rounded-lg transition-colors shadow-md hover:shadow-lg">
              Začít zdarma
            </Link>
            <Link href="/demo" className="border-2 border-white text-white hover:bg-white dark:hover:bg-neutral-950 hover:text-brand-600 dark:hover:text-brand-400 font-semibold py-3 px-8 rounded-lg transition-all">
              Shlédnout demo
            </Link>
          </div>
        </div>
