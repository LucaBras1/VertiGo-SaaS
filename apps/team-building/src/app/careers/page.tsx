    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Kariéra v TeamForge</h1>
      ...
      <section className="px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Proč pracovat s námi?</h2>
      ...
      <section className="px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Otevřené pozice</h2>
              ...
              <div key={position.id} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mt-2">{position.title}</h3>
      ...
      <section className="px-4 py-12">
        <div className="max-w-3xl mx-auto text-center bg-white rounded-2xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Nevidíte pozici pro vás?</h2>
      ...
      <footer className="bg-gray-900 text-white py-8 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-gray-400">&copy; 2025 TeamForge. Všechna práva vyhrazena.</p>
        </div>
      </footer>
    </div>
  )
