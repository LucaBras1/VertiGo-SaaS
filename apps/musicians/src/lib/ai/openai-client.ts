/**
 * OpenAI Client for GigBook Musicians AI Features
 *
...
function getOpenAIClient(): OpenAI | null {
  if (!process.env.OPENAI_API_KEY) {
    console.warn('[OpenAI] OPENAI_API_KEY not set. AI features will use mock data.')
    return null
  }
...
export async function generateCompletion(
  ...
  console.error('[OpenAI] All attempts failed. Falling back to mock data.', lastError)
  return null
}
