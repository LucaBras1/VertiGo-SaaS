  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="text-sm text-gray-600">Celkem klientů</div>
          <div className="text-2xl font-bold text-gray-900 mt-1">{stats.total}</div>
        </Card>
        <Card className="p-4">
          <div className="text-sm text-gray-600">Aktivní klienti</div>
          <div className="text-2xl font-bold text-green-600 mt-1">{stats.active}</div>
        </Card>
        <Card className="p-4">
          <div className="text-sm text-gray-600">Opakovaní klienti</div>
          <div className="text-2xl font-bold text-primary-600 mt-1">{stats.repeat}</div>
        </Card>
        <Card className="p-4">
          <div className="text-sm text-gray-600">Firmy</div>
              ...
              <Link key={client.id} href={`/dashboard/clients/${client.id}`}>
                <Card className="p-6 hover:border-primary-300 hover:shadow-md transition cursor-pointer">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                    <div>
                      <div className="text-xs text-gray-500">Gigy</div>
                      <div className="text-lg font-semibold text-gray-900">
                        {client._count?.gigs || 0}
                      </div>
                    </div>
                    <div>
                      <div className="text-xs text-gray-500">Faktury</div>
