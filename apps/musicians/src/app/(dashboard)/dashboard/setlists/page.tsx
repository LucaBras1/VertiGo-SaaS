  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Setlisty</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="text-sm text-gray-600">Celkem setlistů</div>
          <div className="text-2xl font-bold text-gray-900 mt-1">{stats.total}</div>
        </Card>
        <Card className="p-4">
          <div className="text-sm text-gray-600">Finální</div>
          <div className="text-2xl font-bold text-green-600 mt-1">{stats.finalized}</div>
        </Card>
        <Card className="p-4">
          <div className="text-sm text-gray-600">AI generované</div>
          ...
          <Card className="p-12 text-center md:col-span-2 lg:col-span-3">
            ...
            {!searchQuery && (
              <div className="flex gap-3 justify-center">
                <Button variant="outline" asChild>
                  <Link href="/dashboard/setlists/new">Vytvořit manuálně</Link>
                </Button>
                <Button asChild>
                  <Link href="/dashboard/setlists/generate">
                    <Sparkles className="w-4 h-4 mr-2" />
