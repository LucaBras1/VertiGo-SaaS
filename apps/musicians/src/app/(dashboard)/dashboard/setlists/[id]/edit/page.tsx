...
export default function EditSetlistPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href={`/dashboard/setlists/${params.id}`} className="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
          <ArrowLeft className="h-4 w-4 mr-1" />
          Zpět na detail
        </Link>
        <h1 className="text-2xl font-bold text-gray-900">Upravit setlist</h1>
        <p className="text-gray-600 mt-1">Upravte skladbu setlistu</p>
      </div>
              ...
              <CardContent>
                {availableSongs.length === 0 ? (
                  <div className="text-center py-4">
                    <p className="text-gray-500 mb-2">Žádné písně</p>
