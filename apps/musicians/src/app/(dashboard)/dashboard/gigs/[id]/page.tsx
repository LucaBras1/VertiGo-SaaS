        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-500">Typ akce</p>
              ...
              <div>
                <p className="text-sm text-gray-500">Počet setů</p>
                <p className="font-medium">{gig.numberOfSets || '-'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Délka setu</p>
              ...
              <div>
                <p className="text-sm text-gray-500">Počet členů</p>
          ...
          {gig.venue && (
            <Card>
              ...
              <CardContent>
                ...
                {gig.venue.city && <p className="text-gray-600">{gig.venue.city}</p>}
                {gig.venue.type && (
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              {gig.clientPhone && (
                <p className="text-sm text-gray-600">{gig.clientPhone}</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Cestovné:</span>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Link href={`/dashboard/setlists/new?gigId=${gig.id}`} className="block">
                <Button variant="outline" className="w-full justify-start">
                  <Music className="h-4 w-4 mr-2" />
                  Vytvořit setlist
                </Button>
              </Link>
              <Link href={`/dashboard/invoices/new?gigId=${gig.id}`} className="block">
                <Button variant="outline" className="w-full justify-start">
