  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <Link href="/dashboard/invoices" className="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 text-sm font-medium text-gray-500">Popis</th>
                    <th className="text-right py-2 text-sm font-medium text-gray-500">Množství</th>
                    <th className="text-right py-2 text-sm font-medium text-gray-500">Cena/ks</th>
                    <th className="text-right py-2 text-sm font-medium text-gray-500">Celkem</th>
                  </tr>
                </thead>
                <tbody>
                ...
                <tfoot>
                  <tr>
                    <td colSpan={3} className="py-2 text-right text-gray-600">Mezisoučet:</td>
                    <td className="py-2 text-right">{formatCurrency(invoice.subtotal / 100)}</td>
                  </tr>
                  <tr>
                    <td colSpan={3} className="py-2 text-right text-gray-600">DPH ({invoice.taxRate}%):</td>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Link href={`/dashboard/clients/${invoice.customer.id}`} className="text-primary-600 hover:underline text-sm">
                Zobrazit profil
              </Link>
            </CardContent>
          </Card>
          ...
          {invoice.gig && (
            <Card>
              ...
              <CardContent>
                <Link href={`/dashboard/gigs/${invoice.gig.id}`} className="text-primary-600 hover:underline">
                  {invoice.gig.title}
                </Link>
              </CardContent>
            </Card>
