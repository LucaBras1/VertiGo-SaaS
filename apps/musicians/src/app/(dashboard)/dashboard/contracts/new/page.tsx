...
export default function NewContractPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Nová smlouva</h1>
                ...
                <div className="grid grid-cols-2 gap-4 mt-2">
                  <button
                    ...
                    className={`p-4 border rounded-lg text-left transition-colors ${
                      language === 'CS' ? 'border-primary-500 bg-primary-50' : 'hover:border-gray-300'
                    }`}
                  >
                    <p className="font-semibold">Čeština</p>
                    <p className="text-sm text-gray-500">Smlouva v českém jazyce</p>
                  </button>
                  <button
                    onClick={() => setLanguage('EN')}
                    className={`p-4 border rounded-lg text-left transition-colors ${
                      language === 'EN' ? 'border-primary-500 bg-primary-50' : 'hover:border-gray-300'
                    }`}
                  >
                    <p className="font-semibold">English</p>
                    <p className="text-sm text-gray-500">Contract in English</p>
                  </button>
                </div>
              </div>
            </div>
          ...
          {step === 'review' && generatedContract && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input value={generatedContract.title} readOnly className="bg-gray-50" />
              </div>
                ...
                <div className="mt-2 space-y-2 max-h-60 overflow-y-auto">
                  {generatedContract.sections.map((section, i) => (
                    <div key={i} className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-xs text-gray-500 truncate">{section.content}</p>
                    </div>
                  ))}
                </div>
              </div>
