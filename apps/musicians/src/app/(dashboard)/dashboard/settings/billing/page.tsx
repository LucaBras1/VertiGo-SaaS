        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              {subscription?.tier === 'FREE' ? (
                <Button asChild>
                  <Link href="/dashboard/settings/billing/pricing">Upgrade</Link>
                </Button>
              ) : (
                <>
                  <Button variant="outline" asChild>
                    <Link href="/dashboard/settings/billing/pricing">Change Plan</Link>
                  </Button>
                  {subscription?.hasStripeSubscription && (
        ...
        <CardContent className="space-y-4">
          ...
          {!subscription?.hasStripeSubscription && subscription?.tier === 'FREE' && (
            <div className="text-center py-8">
              ...
              <Button asChild>
                <Link href="/dashboard/settings/billing/pricing">View Plans</Link>
              </Button>
            </div>
          )}
        </CardContent>
