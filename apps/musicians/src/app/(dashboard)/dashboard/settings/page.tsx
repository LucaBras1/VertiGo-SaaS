  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Správa vašeho účtu a preferencí</p>
      </div>
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Email při nové poptávce</p>
                    </div>
                  </label>
                  <label className="flex items-center gap-3">
                    <input
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Email při potvrzení zakázky</p>
                    </div>
                  </label>
                  <label className="flex items-center gap-3">
                    <input
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Email při přijetí platby</p>
                    </div>
                  </label>
                  <label className="flex items-center gap-3">
                    <input
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Připomínka den před akcí</p>
                    </div>
                  </label>
                </div>
                <div className="flex justify-end">
