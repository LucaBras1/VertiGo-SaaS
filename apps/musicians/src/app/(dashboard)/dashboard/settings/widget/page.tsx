...
export default function WidgetSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Rezervační widget</h1>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Když je vypnutý, formulář zobrazí chybovou hlášku</p>
                </div>
                <button
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg text-center">
                  <p className="text-2xl font-bold text-gray-900">{widget._count.inquiries}</p>
                  <p className="text-sm text-gray-500">Celkem poptávek</p>
                </div>
              </div>
              <p className="text-sm text-gray-500 mt-4">
                Podrobné statistiky najdete v sekci{' '}
                <Link href="/dashboard/gigs" className="text-primary-600 hover:underline">
                  Gigs
                </Link>
              </p>
            </CardContent>
