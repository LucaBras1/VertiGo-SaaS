  ...
  async function handleConvert(id: string) {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push(`/dashboard/gigs/${data.data.id}`)
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Správa poptávek z booking widgetu</p>
        </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Nových</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Převedených</p>
                </div>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {inquiry.gig && (
                        <div className="mt-3">
                          <Link
                            href={`/dashboard/gigs/${inquiry.gig.id}`}
