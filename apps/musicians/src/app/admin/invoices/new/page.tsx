  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Nová faktura</h1>
        <p className="text-neutral-600 dark:text-neutral-400 mt-1">Vytvořte novou fakturu</p>
      </div>
