        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-neutral-500 dark:text-neutral-400">posledních 6 měsíců</span>
            </div>
          </CardHeader>
          <CardContent>
            {revenueData.every((d) => d.revenue === 0) ? (
              <div className="text-center py-8">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">Zatím žádné příjmy</p>
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Grafy se zobrazí po prvních zaplacených fakturách</p>
              </div>
            ) : (
          ...
          <CardContent>
            <div className="text-center py-4">
              <div className="relative inline-flex items-center justify-center">
                ...
                <span className="absolute text-3xl font-bold text-neutral-900 dark:text-neutral-100">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/admin/gigs">Zobrazit vše</Link>
              </Button>
            </div>
          </CardHeader>
          <CardContent>
            {upcomingGigs.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-neutral-600 dark:text-neutral-400">Žádné nadcházející gigy</p>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h4 className="font-semibold text-neutral-900 dark:text-neutral-100">{gig.title}</h4>
                          {gig.venueName && (
                            <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">{gig.venueName}</p>
                          )}
