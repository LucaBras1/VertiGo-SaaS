  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Gigy</h1>
          <p className="text-neutral-600 dark:text-neutral-400 mt-1">Správa vašich zakázek a vystoupení</p>
        </div>
        <Button asChild>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="text-sm text-neutral-600 dark:text-neutral-400">Celkem gigů</div>
          <div className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mt-1">{stats.total}</div>
        </Card>
        <Card className="p-4">
          <div className="text-sm text-neutral-600 dark:text-neutral-400">Potvrzeno</div>
        ...
        <Card className="p-4">
          <div className="text-sm text-neutral-600 dark:text-neutral-400">Celková hodnota</div>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <Link href={`/admin/gigs/${gig.id}`} className="flex-1">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 text-sm text-neutral-600 dark:text-neutral-400">
