  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <Link href="/admin/repertoire" className="inline-flex items-center text-sm text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:text-neutral-300 mb-4">
            <ArrowLeft className="h-4 w-4 mr-1" />
            Zpět na repertoár
          </Link>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{song.title}</h1>
          {song.artist && <p className="text-neutral-600 dark:text-neutral-400 mt-1">{song.artist}</p>}
        </div>
        <div className="flex gap-2">
          <Link href={`/admin/repertoire/${song.id}/edit`}>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Žánr</p>
                <p className="font-medium">{song.genre || '-'}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Nálada</p>
                <p className="font-medium">{song.mood ? moodLabels[song.mood] || song.mood : '-'}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Tónina</p>
                <p className="font-medium">{song.key || '-'}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">BPM</p>
                <p className="font-medium flex items-center gap-1">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Obtížnost</p>
                <p className="font-medium">{song.difficulty || '-'}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Vokály</p>
                <p className="font-medium">{song.vocals || '-'}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Zahráno</p>
