        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-neutral-600 dark:text-neutral-400">Správa účtu a preferencí</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-64 flex-shrink-0">
            <nav className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 overflow-hidden">
              {tabs.map((tab) => {
                const Icon = tab.icon
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === tab.id
                        ...
                        : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:bg-neutral-950 border-l-4 border-transparent'
                    )}
                  >
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 p-6">
              {activeTab === 'profile' && (
                <form onSubmit={profileForm.handleSubmit(handleProfileSubmit)} className="space-y-6">
                  <div>
                    <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Osobní údaje</h2>
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          type="text"
                          className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                        />
              ...
              {activeTab === 'business' && (
                <form onSubmit={businessForm.handleSubmit(handleBusinessSubmit)} className="space-y-6">
                  <div>
                    <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Údaje o firmě</h2>
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">
                          Název firmy / studia
              ...
              {activeTab === 'notifications' && (
                <div className="space-y-6">
                  <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Nastavení notifikací</h2>
              ...
              {activeTab === 'calendar' && (
                <div className="space-y-6">
                  <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Synchronizace kalendáře</h2>
                  <CalendarSettings />
                </div>
              )}
              ...
              {activeTab === 'security' && (
                <div className="space-y-6">
                  <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Zabezpečení účtu</h2>

                  <div className="space-y-4">
                    <div className="p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                      <h3 className="font-medium text-neutral-900 dark:text-neutral-100 mb-2">Změna hesla</h3>
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
                        Pravidelná změna hesla zvyšuje bezpečnost vašeho účtu
                      </p>
                      <button className="px-4 py-2 border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300 rounded-lg hover:bg-neutral-50 dark:bg-neutral-950 transition-colors">
                        Změnit heslo
                      </button>
                    </div>

                    <div className="p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                      <h3 className="font-medium text-neutral-900 dark:text-neutral-100 mb-2">Dvoufaktorové ověření</h3>
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
                    ...
                    <div className="p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                      <h3 className="font-medium text-neutral-900 dark:text-neutral-100 mb-2">Aktivní relace</h3>
                      <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-4">
