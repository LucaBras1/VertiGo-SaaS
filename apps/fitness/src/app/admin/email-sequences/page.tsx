  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Email sekvence</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Celkem sekvenci</p>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Aktivni sekvence</p>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Aktivni enrollment</p>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">Odeslanych emailu</p>
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="bg-neutral-50 dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-700">
            ...
            <tbody className="divide-y divide-neutral-200 dark:divide-neutral-700">
              {sequences.length === 0 ? (
                ...
                sequences.map((sequence) => (
                  <tr
                    key={sequence.id}
                    className="hover:bg-neutral-50 dark:bg-neutral-950 cursor-pointer"
                    onClick={() => setSelectedSequence(selectedSequence === sequence.id ? null : sequence.id)}
                  >
                    <td className="px-6 py-4">
                      <div>
                        <p className="font-medium text-neutral-900 dark:text-neutral-100">{sequence.name}</p>
