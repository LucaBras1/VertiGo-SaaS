        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Skupinové lekce</h1>
                <p className="text-gray-600">Správa skupinových fitness lekcí</p>
              </div>
            </div>
            <button
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6">
        {isLoading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Žádné lekce</h3>
            <p className="text-gray-500 mb-4">Začněte přidáním první skupinové lekce</p>
            <button
              onClick={() => handleOpenModal()}
                    ...
                    <div>
                      <span
                        className={cn(
                          ...
                          statusConfig[fitnessClass.status]?.color || 'bg-gray-100 text-gray-800'
                        )}
                      >
                        {statusConfig[fitnessClass.status]?.label || fitnessClass.status}
                      </span>
                      <h3 className="text-lg font-semibold text-gray-900">{fitnessClass.name}</h3>
                    </div>
