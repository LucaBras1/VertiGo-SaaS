...
const sessionStatusLabels: Record<string, { label: string; color: string }> = {
  ...
  cancelled: { label: 'Zrušeno', color: 'bg-gray-100 text-gray-800' },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Menu as="div" className="relative">
                <Menu.Button className="p-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{client._count.sessions}</p>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{client.creditsRemaining}</p>
                    <p className="text-sm text-gray-500">Kredity</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Váha</p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Cílová váha</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-900">Poslední sessions</h2>
                <Link
                  href={`/dashboard/sessions?client=${client.id}`}
                  ...
                  {client.sessions.slice(0, 5).map((session) => (
                    <div key={session.id} className="px-6 py-4 flex items-center justify-between">
                      ...
                      <span
                        className={cn(
                          'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium',
                          sessionStatusLabels[session.status]?.color || 'bg-gray-100 text-gray-800'
                        )}
                      >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-900">Měření</h2>
                ...
                <div className="divide-y divide-gray-200">
                  {client.measurements.slice(0, 5).map((measurement) => (
                    <div key={measurement.id} className="px-6 py-4 flex items-center justify-between">
                      <div>
                        <p className="font-medium text-gray-900">{formatDate(measurement.date)}</p>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              {client.goals.length === 0 ? (
                <p className="text-gray-500">Žádné cíle</p>
              ) : (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Úroveň kondice</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Výška</span>
                  <span className="text-sm font-medium text-gray-900">
                    {client.height ? `${client.height} cm` : '-'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Typ členství</span>
                  <span className="text-sm font-medium text-gray-900">
                    {client.membershipType || '-'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Členem od</span>
                  <span className="text-sm font-medium text-gray-900">
