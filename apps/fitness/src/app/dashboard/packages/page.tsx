        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Balíčky</h1>
                <p className="text-gray-600">Správa členských balíčků a kreditů</p>
              </div>
            </div>
            <button
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6">
        {isLoading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Žádné balíčky</h3>
            <p className="text-gray-500 mb-4">Začněte vytvořením prvního balíčku</p>
            <button
              onClick={() => handleOpenModal()}
