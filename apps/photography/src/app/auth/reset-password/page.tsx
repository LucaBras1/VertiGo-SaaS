...
import { z } from 'zod'
import { Lock, ArrowLeft, Loader2, CheckCircle, Eye, EyeOff, XCircle, Camera } from 'lucide-react'
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-gray-50 flex items-center justify-center">
