...
export default function EditClientPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      {/* Header */}
      <div>
        <Link href={`/admin/clients/${clientId}`} className="inline-flex items-center text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:text-neutral-100 mb-4">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Client
        </Link>
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Edit Client</h1>
        <p className="text-neutral-600 dark:text-neutral-400 mt-1">Update client profile</p>
      </div>
