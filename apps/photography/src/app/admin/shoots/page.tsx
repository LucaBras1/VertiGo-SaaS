  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Photography Shoots</h1>
          <p className="text-neutral-600 dark:text-neutral-400 mt-1">Manage your scheduled photo sessions</p>
        </div>
      ...
      {upcomingShoots.length > 0 && (
        <div>
          <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Upcoming Shoots</h2>
      ...
      {pastShoots.length > 0 && (
        <div>
          <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Past Shoots</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {filteredShoots.length === 0 && (
        <Card>
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-2">No shoots found</h3>
    ...
    <Link href={`/admin/shoots/${shoot.id}`}>
      <Card hover className="h-full">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <h3 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1">{shoot.package.client.name}</h3>
            <p className="text-sm text-neutral-600 dark:text-neutral-400">{shoot.package.eventType}</p>
          </div>
