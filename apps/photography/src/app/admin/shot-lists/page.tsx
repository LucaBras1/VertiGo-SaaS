...
export default function ShotListsPage() {
  ...
  const handleGenerated = async (result: {
    ...
    try {
      ...
      router.push(`/admin/shot-lists/${newShotList.id}`)
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Shot Lists</h1>
          <p className="text-neutral-600 dark:text-neutral-400 mt-1">Organize your shots for every session</p>
        </div>
        <div className="flex gap-2">
          ...
          <Link href="/admin/shot-lists/new">
            <Button>
      ...
      {filteredShotLists.length === 0 ? (
        <Card className="p-12 text-center">
          <ListChecks className="w-12 h-12 text-neutral-400 dark:text-neutral-500 mx-auto mb-4" />
          <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-2">No shot lists yet</h3>
          <p className="text-neutral-600 dark:text-neutral-400 mb-4">Create your first shot list or let AI generate one for you</p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-right hidden sm:block">
                        <p className="text-sm font-medium text-neutral-900 dark:text-neutral-100">{list.totalShots} shots</p>
                        <p className="text-xs text-neutral-500 dark:text-neutral-400">{list.mustHaveCount} must-have</p>
                      </div>

                      {list.estimatedTime && (
                        <div className="flex items-center gap-1 text-sm text-neutral-600 dark:text-neutral-400 hidden md:flex">
