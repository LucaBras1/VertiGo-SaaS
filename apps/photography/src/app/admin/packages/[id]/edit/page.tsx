...
export default function EditPackagePage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      {/* Header */}
      <div>
        <Link href={`/admin/packages/${params.id}`} className="inline-flex items-center text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:text-neutral-100 mb-4">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Package
        </Link>
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Edit Package</h1>
        <p className="text-neutral-600 dark:text-neutral-400 mt-1">Update package details</p>
      </div>
