...
export default function NewPackagePage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      {/* Header */}
      <div>
        <Link href="/admin/packages" className="inline-flex items-center text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:text-neutral-100 mb-4">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Packages
        </Link>
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Create New Package</h1>
        <p className="text-neutral-600 dark:text-neutral-400 mt-1">Set up a new photography package for your client</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          ...
          <div className="space-y-4">
            <div>
              ...
              {clients.length === 0 && !clientsLoading && (
                <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                  No clients found.{' '}
                  <Link href="/admin/clients/new" className="text-amber-600 hover:text-amber-700">
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Package Title *</label>
              <input
                {...register('title')}
                type="text"
                className="w-full px-4 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Event Date</label>
                <input
                  {...register('eventDate')}
                  type="date"
                  className="w-full px-4 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Shot Count</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Delivery Days</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Editing Hours</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Style Tags</label>
              <input
                type="text"
                className="w-full px-4 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
              ...
              />
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Comma-separated</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Equipment</label>
              <input
                type="text"
                className="w-full px-4 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
            ...
            <div className="flex flex-col gap-3 justify-center">
              <label className="flex items-center">
                ...
                />
                <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Second Shooter</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="mr-2 rounded border-neutral-300 dark:border-neutral-600 text-amber-500 focus:ring-amber-500"
                />
                <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">RAW Files Included</span>
              </label>
            </div>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Base Price ($)</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Travel Costs ($)</label>
              <input
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Total Price ($)</label>
              <input
