  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Contracts</h1>
          <p className="text-neutral-600 dark:text-neutral-400">Manage client contracts and agreements</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          <p className="text-sm text-neutral-500 dark:text-neutral-400">Signed</p>
      ...
      <Card className="p-4">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <select
            ...
            className="px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
          >
      ...
      {error ? (
        ...
        <Card className="p-12 text-center">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 mt-4">Loading contracts...</p>
        </Card>
      ) : (
