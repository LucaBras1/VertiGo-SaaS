  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">New Contract</h1>
          <p className="text-neutral-600 dark:text-neutral-400">Create a new contract for your client</p>
        </div>
      </div>
