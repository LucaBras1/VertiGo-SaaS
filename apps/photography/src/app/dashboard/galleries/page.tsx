    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage your photo galleries and client deliverables</p>
        </div>
      ...
      {filteredGalleries.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600 mb-4">Create your first gallery to start organizing photos</p>
          <Link href="/dashboard/galleries/new">
            <Button>
              <Plus className="w-4 h-4 mr-2" />
              Create Gallery
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{gallery.shoot?.package?.client?.name}</p>
                      </div>
