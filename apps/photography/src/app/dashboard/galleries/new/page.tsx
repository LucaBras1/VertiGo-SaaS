...
export default function NewGalleryPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      {/* Header */}
      <div>
        <Link href="/dashboard/galleries" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Galleries
        </Link>
        <h1 className="text-3xl font-bold text-gray-900">Create New Gallery</h1>
        <p className="text-gray-600 mt-1">Set up a photo gallery for your client</p>
      </div>
