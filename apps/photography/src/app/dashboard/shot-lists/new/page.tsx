...
export default function NewShotListPage() {
  ...
  const handleGenerateWithAI = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/shot-lists/${savedList.id}`)
    } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/dashboard/shot-lists/${data.id}`)
    } catch (error) {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      {/* Header */}
      <div>
        <Link href="/dashboard/shot-lists" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Shot Lists
        </Link>
        <h1 className="text-3xl font-bold text-gray-900">Create Shot List</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <label className="flex items-center flex-1 p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                <input
                  type="radio"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Let AI create a comprehensive shot list</p>
                </div>
              </label>
        ...
        {formData.useAI && (
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Must-Have Shots</label>
                <textarea
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Enter specific shots you don't want to miss</p>
              </div>
            </div>
          </Card>
        )}
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/dashboard/shot-lists">
