    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card text-center py-12">
          ...
          <Link href="/dashboard/events" className="btn-primary inline-flex">
            Return to Events
          </Link>
        </div>
      </div>
                ...
                {event.venue && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <Link
                        href={`/dashboard/venues/${event.venue.id}`}
                ...
                {event.client && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <Link
                        href={`/dashboard/clients/${event.client.id}`}
                        className="text-primary-600 hover:text-primary-700 font-medium"
                      >
                        {event.client.name}
                      </Link>
              ...
              <div className="card">
                ...
                <div className="space-y-2">
                  {event.bookings.slice(0, 3).map((booking) => (
                    <Link
                      key={booking.id}
                      href={`/dashboard/performers/${booking.performer.id}`}
