      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/admin/events" className="text-primary-600 hover:text-primary-700 text-sm font-medium inline-flex items-center">
              View All
          ...
          <div className="space-y-4">
            {data?.upcomingEvents.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <Link href="/admin/events/new" className="text-primary-600 hover:text-primary-700 text-sm mt-2 inline-block">
