...
/**
 * Public Activity Detail Page - Client Component
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {activity.skillsDeveloped.map((skill: string, index: number) => (
                ...
                <CardContent className="space-y-4">
                  ...
                  {activity.allergensInvolved.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {activity.allergensInvolved.map((allergen: string) => (
                ...
                {activity.ageAppropriate.length > 0 && (
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {activity.ageAppropriate.map((age: string) => (
