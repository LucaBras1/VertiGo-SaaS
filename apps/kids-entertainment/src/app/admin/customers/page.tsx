      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card variant="outlined" className="p-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-gray-500">Opakovaní</p>
        ...
        <Card variant="outlined" className="p-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-gray-500">Průměrné LTV</p>
              <p className="text-xl font-bold text-gray-900">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {children && children.length > 0 ? (
                          ...
                          {children.map((child, index) => (
                            <div key={index} className="bg-white p-3 rounded-lg border">
                              <p className="font-medium">
                                {child.name}
                                {child.age && <span className="text-gray-500"> ({child.age} let)</span>}
                              </p>
                              {child.interests && (
                        ...
                        <p className="text-sm text-gray-500">Žádné děti v záznamu</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-gray-600">Počet oslav:</span>
                          <span className="font-medium">{customer.totalPartiesBooked}</span>
                        </div>
                        {customer.lastPartyDate && (
                          <div className="flex justify-between">
                            <span className="text-gray-600">Poslední oslava:</span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-gray-600">Zákazníkem od:</span>
                          <span className="font-medium">
                      ...
                      {customer.preferredThemes && customer.preferredThemes.length > 0 && (
                        <div className="mt-4">
                          <p className="text-sm text-gray-600 mb-2">Oblíbená témata:</p>
