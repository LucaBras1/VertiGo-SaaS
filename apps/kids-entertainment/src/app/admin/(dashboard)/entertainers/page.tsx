  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Animátoři</h1>
          <p className="text-neutral-600 dark:text-neutral-400 mt-1">Správa týmu animátorů a jejich certifikací</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{entertainers.length}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-sm text-neutral-500 dark:text-neutral-400">Neaktivní</p>
            ...
            >
              <div className="p-6">
                ...
                <div className="space-y-2 text-sm mb-4">
                  ...
                  {entertainer.email && (
                    <a
                      ...
                      className="flex items-center text-neutral-600 dark:text-neutral-400 hover:text-partypal-pink-600"
                    >
                ...
                {entertainer.ageGroups.length > 0 && (
                  <div className="mb-4">
                    <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-1">Věkové skupiny:</p>
                    <div className="flex flex-wrap gap-1">
