  ...
  if (!party) {
    return (
      <div className="text-center py-12">
        <p className="text-neutral-500 dark:text-neutral-400">Oslava nenalezena</p>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 flex items-center gap-3">
              ...
              {party.childAge && <span className="text-neutral-500 dark:text-neutral-400 font-normal">({party.childAge} let)</span>}
            </h1>
            {party.package?.title && (
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 flex items-center">
              ...
              {party.ageRange && (
                <div>
                  <p className="text-sm text-neutral-500 dark:text-neutral-400">Věkové rozmezí</p>
            ...
            {party.childInterests && party.childInterests.length > 0 && (
              <div className="mt-4">
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">Zájmy dítěte</p>
          ...
          <Card className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">Rodič / Objednavatel</p>
                <div className="space-y-2">
                  <p className="font-medium flex items-center">
                    <User className="h-4 w-4 mr-2 text-neutral-400 dark:text-neutral-500" />
                    {party.parentName}
                  </p>
                  {party.parentPhone && (
              ...
              {party.emergencyContact && (
                <div>
                  <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">Nouzový kontakt</p>
                  <div className="space-y-2">
                    <p className="font-medium">
                      {party.emergencyContact.name}
                      {party.emergencyContact.relation && (
                        <span className="text-neutral-500 dark:text-neutral-400 font-normal"> ({party.emergencyContact.relation})</span>
                      )}
                    </p>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            ...
            <select
              ...
              className="w-full rounded-lg border-neutral-300 dark:border-neutral-600 mb-3"
            >
          ...
          <Card className="p-6">
            ...
            {checklist ? (
              <div className="space-y-3">
                <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase font-medium">Před oslavou</p>
                {[
                  ...
                  <label key={key} className="flex items-center cursor-pointer">
                    ...
                    />
                    <span className="ml-3 text-sm text-neutral-700 dark:text-neutral-300">{label}</span>
                  </label>
                ))}

                <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase font-medium mt-4">Během oslavy</p>
                {[
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase font-medium mt-4">Po oslavě</p>
                {[
              ...
              <p className="text-sm text-neutral-500 dark:text-neutral-400">Checklist není k dispozici</p>
            )}
          </Card>
        </div>
      </div>
