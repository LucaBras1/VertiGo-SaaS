  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100">Aktivity</h1>
          <p className="text-neutral-600 dark:text-neutral-400 mt-1">Spravujte party aktivity</p>
        </div>
          ...
          <Card key={activity.id} variant="outlined" className="flex flex-col">
            <div className="p-6 flex-1">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-neutral-600 dark:text-neutral-400">Bezpečnost:</span>
                  {getSafetyBadge(activity.safetyRating)}
                </div>
                {activity.energyLevel && (
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-neutral-600 dark:text-neutral-400">Energie:</span>
