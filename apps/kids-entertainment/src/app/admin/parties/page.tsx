    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Správa party akcí a rezervací</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <select
          ...
          className="rounded-lg border-gray-300 text-sm focus:ring-partypal-pink-500 focus:border-partypal-pink-500"
        >
