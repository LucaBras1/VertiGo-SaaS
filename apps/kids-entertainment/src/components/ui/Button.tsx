...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      outline:
        'bg-transparent border-2 border-partypal-pink-500 text-partypal-pink-500 hover:bg-partypal-pink-50 focus:ring-partypal-pink-400',
    }
