...
export default function NewProductionPage() {
  ...
  const onSubmit = async (data: ProductionFormData) => {
    ...
    try {
      ...
      router.push(`/dashboard/productions/${result.id}`)
    } catch (error) {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Create a new theater production</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <div>
                <label htmlFor="hasIntermission" className="text-sm font-medium text-gray-700">
                  Has Intermission
                </label>
                <p className="text-sm text-gray-500">Check if the show includes an intermission</p>
              </div>
            </div>
            ...
            {hasIntermission && (
              <div className="ml-7">
                ...
                <input
                  ...
                  className="w-full max-w-xs px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all"
                  placeholder="15"
                />
              </div>
            )}
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="playwright" className="block text-sm font-medium text-gray-700 mb-1">
                Playwright
              </label>
              <input
                id="playwright"
