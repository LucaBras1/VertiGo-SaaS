...
import type { AdminConfig, NavEntry } from '../types'
...
export function AdminSidebar({
  ...
  const ProductIcon = config.productIcon
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
      ...
      <div className={cn(
        ...
        <Link href={config.basePath} className="flex items-center gap-2.5" onClick={onCloseMobile}>
          <div className={cn('flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br text-white', config.gradient)}>
      ...
      >
        <div className="space-y-1">
          {config.navigation.map((entry: NavEntry) => {
